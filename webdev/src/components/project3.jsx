...
const Cards1 = ({ isActive }) => {
  return (
    <div
      className={`
        w-70 h-100 flex flex-col items-center rounded-2xl transition-all duration-500 ease-in-out
...
const Cards2 = ({ isActive }) => {
  return (
    <div
      className={`
        w-70 h-100 flex flex-col justify-between items-center rounded-2xl p-4
        transition-all duration-500 ease-in-out
        ${isActive 
          ? 'bg-teal-500 scale-110 shadow-2xl translate-y-0 opacity-100' 
          : 'bg-teal-300 scale-90 opacity-60 translate-y-10'}
      `}
    >
      <Navbar />
...
const Navbar = () => {
  return (
    <div className='flex flex-row justify-between border-solid rounded-2xl'>
        <div className='w-20 bg-gray-900 border-solid rounded-2xl h-6'></div>
    </div>
  )
}
